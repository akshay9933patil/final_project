    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Customer', 'Customer'), ('Loan Representative', 'Loan Representative'), ('Operational Head', 'Operational Head'), ('Loan Sanction Officer', 'Loan Sanction Officer'), ('Admin', 'Admin')], default='customer', max_length=50)),
